...
// ^sorry that's a long line^
  ...
  distribute_sb(myneighb, mycoords, local_par, prcperdim, source_bank, &my_sourcebank);
  free_bank(source_bank); ///is this appropriate placement?
  }
  else distribute_sb(myneighb, mycoords, local_par, prcperdim, my_sourcebank, &my_sourcebank);
