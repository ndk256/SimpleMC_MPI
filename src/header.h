...
void distrib_particle(int prcoords[3], Parameters *p, int dim, Bank **sb, int myrank);
void distribute_sb(int mycoords[3], Parameters *p, int prcoords[3], int myrank, Bank *sb, Bank **mysb); 
